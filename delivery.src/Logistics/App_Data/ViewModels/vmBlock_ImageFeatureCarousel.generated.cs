...
namespace YuzuDelivery.ViewModels
{
    ...
    [AutoMap(typeof(ImageFeatureCarousel))]
    public partial class vmBlock_ImageFeatureCarousel 
    {
        [Newtonsoft.Json.JsonProperty("imageFeatures", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<vmBlock_ImageFeature> ImageFeatures { get; set; }
