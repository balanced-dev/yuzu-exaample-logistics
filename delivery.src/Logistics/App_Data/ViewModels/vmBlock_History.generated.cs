...
namespace YuzuDelivery.ViewModels
{
    ...
    [YuzuMap("History")]
    public partial class vmBlock_History 
    {
        [Newtonsoft.Json.JsonProperty("title", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public vmBlock_SectionHeader Title { get; set; }
    
        [Newtonsoft.Json.JsonProperty("rte", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Rte { get; set; }
    
        [Newtonsoft.Json.JsonProperty("serviceSummaries", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<vmBlock_ServiceSummary> ServiceSummaries { get; set; }
