...
namespace Logistics.Core.ViewModels
{
    ...
    [AutoMap(typeof(StepList))]
    public partial class vmBlock_StepList 
    {
        ...
        public System.Collections.Generic.List<vmSub_StepListStep> Steps { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.23.0 (Newtonsoft.Json v9.0.0.1)")]
    [AutoMap(typeof(StepListStep))]
    [AutoMap(typeof(StepList))]
    public partial class vmSub_StepListStep 
    {
        [Newtonsoft.Json.JsonProperty("stepNumber", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public System.Collections.Generic.List<vmSub_StepList> List { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.23.0 (Newtonsoft.Json v9.0.0.1)")]
    [AutoMap(typeof(StepList))]
    public partial class vmSub_StepList 
    {
        [Newtonsoft.Json.JsonProperty("text", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Text { get; set; }
