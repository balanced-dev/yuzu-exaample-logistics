...
namespace Logistics.Core.ViewModels
{
    ...
    public partial class vmBlock_Video 
    {
        [Newtonsoft.Json.JsonProperty("poster", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public vmBlock_DataImage Poster { get; set; }
